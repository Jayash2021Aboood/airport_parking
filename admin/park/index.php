...
<main>
                        ...
                        <!-- <tr> 
                                            ...
                                            <td>
                                                <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                                    ...
                                                    data-bs-target="#editParkModal"><i
    ...
    <!-- Create Park modal-->
    <div class="modal fade" id="createParkModal" tabindex="-1" role="dialog" aria-labelledby="createParkModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createParkModalLabel">Create New Park</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formParkName">Park
                                Name</label>
                            <input class="form-control" id="formParkName" type="text"
    ...
    <div class="modal fade" id="editParkModal" tabindex="-1" role="dialog" aria-labelledby="editParkModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editParkModalLabel">Edit Park</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formParkName">Park
                                Name</label>
                            <input class="form-control" id="formParkName" type="text"
                                placeholder="Enter Park name..." value="Sales" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
