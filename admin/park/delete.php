    ...
    if(isset($_POST['deletePark']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = lang("Park Deleted successfuly!");          
          $_SESSION["success"] = lang("Park Deleted successfuly!");          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Park details card-->
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Park Details"); ?> <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deletePark" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
